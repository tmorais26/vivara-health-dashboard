...
const pt = {
  ...
  mobile: {
    detalhesSeguranca: "Detalhes & segurança",
    demografia: "Demografia",
    medica: "Médica",
    contacto: "Contacto",
    mfa: "MFA",
    mfaValor: "Activo · TOTP",
    sessao: "Sessão",
    sessaoValor: "Expira em 14:32",
    acessos: "Acessos",
    ...
    pedirReanalise: "Pedir reanálise",
    carregarDocumento: "Carregar documento",
    nestaSessao: "nesta sessão",
    tirarFoto: "Tirar foto",
    ficheiros: "Ficheiros",
    aProcessar: "a processar…",
    apenasDesktopAviso1: "Edição de marcadores, plano, prescrições e comparação longitudinal está disponível na",
    ...
    toastMensagem: "Mensagem enviada à utente",
    toastNotaGuardada: "Nota guardada (interna)",
    toastPedidoReanalise: "Pedido de reanálise criado",
...
const en: Dicionario = {
  ...
  mobile: {
    detalhesSeguranca: "Details & security",
    demografia: "Demographics",
    medica: "Physician",
    contacto: "Contact",
    mfa: "MFA",
    mfaValor: "Enabled · TOTP",
    sessao: "Session",
    sessaoValor: "Expires in 14:32",
    acessos: "Access log",
    ...
    pedirReanalise: "Request re-test",
    carregarDocumento: "Upload document",
    nestaSessao: "this session",
    tirarFoto: "Take photo",
    ficheiros: "Files",
    aProcessar: "processing…",
    apenasDesktopAviso1: "Editing markers, plan, prescriptions and longitudinal comparison is available in the",
    ...
    toastMensagem: "Message sent to patient",
    toastNotaGuardada: "Note saved (internal)",
    toastPedidoReanalise: "Re-test request created",
