      ...
      <section className="border-b border-border bg-surface-raised px-4 pb-5 pt-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            aria-label={t.mobile.enviarMensagem}
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-border bg-background text-foreground hover:bg-accent"
          >
