  ...
  return (
    <section className="bg-brand-beige py-24 md:py-32">
      <div className="mx-auto max-w-5xl px-6">
        <Reveal>
          <SectionBadge>Porque existimos</SectionBadge>
        ...
        <Reveal delay={0.15}>
          <div className="mt-12 rounded-3xl bg-white border border-black/10 p-8 md:p-12 shadow-sm">
            <p className="text-lg text-brand-muted/85 leading-relaxed max-w-2xl">
              A Vivara Health não nasceu numa sala de reuniões. Nasceu da frustração partilhada
              entre médicos e utentes: análises perdidas em emails, exames espalhados por pastas,
              wearables que ninguém olha em consulta e cada visita a começar do zero.
            </p>
